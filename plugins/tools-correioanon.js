async function handler(m, { usedPrefix, command }) {
    ...
    switch (command) {
        ...
        case 'anonimoinfo': { // Adicionado novo caso para o comando 'anonimoinfo'
...
handler.help = ['start', 'leave', 'next', 'anonimoinfo']; // Adicionei 'anonimoinfo' ao comando de ajuda
handler.tags = ['chat'];
handler.command = ['start', 'leave', 'next', 'anonimoinfo']; // Adicionei 'anonimoinfo' aos comandos
